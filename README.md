...
2. Inicie o servidor local:
   ...
   npm start
   ```
3. Acesse http://localhost:4173 no navegador e ajuste a velocidade ou pause/retome a animação.

Também é possível abrir o `index.html` diretamente no navegador, mas o servidor evita erros de “Not Found” em prévias que esperam um host HTTP.
